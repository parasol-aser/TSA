...
public class MultiRunStatementsFinderX extends ForwardFlowAnalysis<Unit,BitSet>
{
	...
	public MultiRunStatementsFinderX(UnitGraph g, SootMethod sm, Set<SootMethod> multiCalledMethods, CallGraph cg)
	{
		super(g);
		...
		while (it.hasNext()){
			...
			if (stmt.containsInvokeExpr()){
				...
				if (invokeExpr instanceof StaticInvokeExpr){
					...
					if (Util.shouldAnalyzeMethod(method)){
						targetList = findTargetMethods(stmt, callGraph, true, true);
					}
				}
