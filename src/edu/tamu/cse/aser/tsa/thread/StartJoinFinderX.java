...
public class StartJoinFinderX
{
	...
	public StartJoinFinderX(CallGraph callGraph, PAG pag)
	{
    	...
    	while (runAnalysisClassesIt.hasNext()) 
    	{
    	    ...
    	    while (methodsIt.hasNext())
    	    {
				...
				if(mayHaveStartStmt && method.isConcrete())
				{
    				...
    				StartJoinAnalysisX sja = new StartJoinAnalysisX(new ExceptionalUnitGraph(b), method, callGraph, pag);
