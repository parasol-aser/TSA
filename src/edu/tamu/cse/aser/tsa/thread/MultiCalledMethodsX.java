...
public class MultiCalledMethodsX{
	
	Set<SootMethod> multiCalledMethods = new HashSet<SootMethod>();
	
	public MultiCalledMethodsX(PegCallGraphX pcg){
		byMCalledS0(pcg);
		finder1(pcg);
		finder2(pcg);
		propagate(pcg);
	...
	private void byMCalledS0(PegCallGraphX pcg) {
	...
	private void propagate(PegCallGraphX pcg){
	...
	private void finder1(PegCallGraphX pcg){
	...
	private void finder2(PegCallGraphX pcg){
	...
	private void visitNode(SootMethod node, PegCallGraphX pcg, Set<SootMethod> first, Set<SootMethod> second){
